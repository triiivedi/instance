...
<body bgcolor=aliceblue leftmargin=0 topmargin=0>
   ...
   <td colspan=4 width="381" height="70">
    <p align="center"><font color="#996633" size="5">&nbsp;</font><font size="5"><b>FILE FIR
   </b></font></p>
  <p align="center">&nbsp;</p>
  <div align="center">
    <center>
...
%>
        ...
        <td width="38%" align="right"><font size="2" face="Verdana" color="#000000"><b>Registration
          Date </b></font></td>
        <td width="25%"><input type="date" date-date-inline-picker="true" name="T1" value="" size="20" tabindex="5"></td>
      </tr>
      <tr>
...
%>
      ...
      <tr>
        ...
        <td width="38%" align="right"><font size="2" face="Verdana" color="#000000"><b>Crime
          Date</b></font></td>
        <td width="25%"><input "date" date-date-inline-picker="true" name="T4" value="" size="20" tabindex="8"></td>
      </tr>
       </tr>
   </form>
  <tr>
